...
//                   <div class="detail-value">${tableOrder.customer_name || 'N/A'}</div>
//                 </div>
//                 <div class="detail-item">
//                   <div class="detail-label">Date</div>
//                   <div class="detail-value">${new Date(
...
//             <DialogTitle>{displayTableNumber} - Order Details</DialogTitle>
//             <DialogDescription>
//               No active order information available for this table.
//             </DialogDescription>
//           </DialogHeader>
//           <div className="py-8 text-center text-gray-500">
//             <div className="text-lg mb-2">📋</div>
//             <div className="font-medium">No active order found for this table.</div>
//             <div className="text-sm mt-1">This table doesn't have any pending orders.</div>
//           </div>
//         </DialogContent>
//       </Dialog>
//     );
...
//           <DialogTitle>{displayTableNumber} - Order Details</DialogTitle>
//           <DialogDescription>
//             View and manage the current order for this table.
//           </DialogDescription>
//         </DialogHeader>
...
const OrderDetailsDialog = ({
  ...
  const [tableOrder, setTableOrder] = useState<any | null>(null);
  const [loading, setLoading] = useState(false);
  const [sendingEmail, setSendingEmail] = useState(false); // Track email sending
  const restaurantId = "681f3a4888df8faae5bbd380";
      ...
      <DialogContent>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div><span className="font-medium">Customer:</span> {tableOrder.customer_name || 'N/A'}</div>
